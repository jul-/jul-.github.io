$( document ).ready(function() {
  ...
  var rebindNodeLinks = function() {
    $( '#node-link-rootnode5node3node3' ).unbind();
    $( '#node-link-rootnode5node3node3-mobile' ).unbind();
    $( '#node-link-rootnode1node3' ).unbind();
    $( '#node-link-rootnode1node3-mobile' ).unbind();
    $( '#node-link-rootnode1node1node1' ).unbind();
    $( '#node-link-rootnode1node1node1-mobile' ).unbind();
    $( '#node-link-rootnode1' ).unbind();
    $( '#node-link-rootnode1-mobile' ).unbind();
    $( '#node-link-rootnode4' ).unbind();
    $( '#node-link-rootnode4-mobile' ).unbind();
    $( '#node-link-rootnode2node2node5' ).unbind();
    $( '#node-link-rootnode2node2node5-mobile' ).unbind();
    $( '#node-link-rootnode2' ).unbind();
    $( '#node-link-rootnode2-mobile' ).unbind();

    $( '#node-link-rootnode5node3node3' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo5(NavigationType.NAVIGATION);
      node5To53(NavigationType.NAVIGATION);
      node53To533(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
      $('.nav-back-link').addClass('hidden');
    });
    $( '#node-link-rootnode5node3node3-mobile' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo5(NavigationType.NAVIGATION);
      node5To53(NavigationType.NAVIGATION);
    ...
    $( '#node-link-rootnode1node3' ).one( 'click', function() {
      event.preventDefault();
      node1To13(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
      $('.nav-back-link').addClass('hidden');
    });
    $( '#node-link-rootnode1node3-mobile' ).one( 'click', function() {
      event.preventDefault();
      node1To13(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
      $('.nav-back-link').addClass('hidden');
    });
    $( '#node-link-rootnode1node1node1' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo1(NavigationType.NAVIGATION);
      node1To11(NavigationType.NAVIGATION);
      node11To111(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
      $('.nav-back-link').addClass('hidden');
    });
    $( '#node-link-rootnode1node1node1-mobile' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo1(NavigationType.NAVIGATION);
      node1To11(NavigationType.NAVIGATION);
    ...
    $( '#node-link-rootnode1' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo1(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
    ...
    $( '#node-link-rootnode1-mobile' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo1(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
    ...
    $( '#node-link-rootnode4' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
    ...
    $( '#node-link-rootnode4-mobile' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo4(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
    ...
    $( '#node-link-rootnode2node2node5' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo2(NavigationType.NAVIGATION);
      node2To22(NavigationType.NAVIGATION);
      node22To225(NavigationType.NAVIGATION);
      $('.dropdown').removeClass('open');
      $('.nav-back-link').addClass('hidden');
    });
    $( '#node-link-rootnode2node2node5-mobile' ).one( 'click', function() {
      event.preventDefault();
      backToRoot(false);
      nodeRootTo2(NavigationType.NAVIGATION);
      node2To22(NavigationType.NAVIGATION);
  ...
  var initNodes = function() {
    ...
    node3Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node4Polygone5Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node5Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  ...
  var resetNode1 = function() {
    ...
    node12Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node13Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  ...
  var resetNode2 = function() {
    ...
    node21Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node22Polygone7Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node23.attr( { visibility: 'hidden' } );
    node23Polygone1.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Polygone2.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Polygone3.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Polygone4.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Text1.attr( { visibility: 'hidden' } );
    node23Text2.attr( { visibility: 'hidden' } );
    node23Text3.attr( { visibility: 'hidden' } );
    node23Text4.attr( { visibility: 'hidden' } );
    node23Circle1.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Circle2.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    node23Circle3.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  }
  ...
  var initNode2 = function() {
   ...
   node2Polygone3Mobile.attr( { visibility: 'visible', transform: 's1,1'  } );
   node2Polygone4.attr( { visibility: 'visible', transform: 's1,1'  } );
   node2Circle1.attr( { visibility: 'visible', transform: 's1,1'  } );
   node2Circle2.attr( { visibility: 'visible', transform: 's1,1'  } );
   node2Circle3.attr( { visibility: 'visible', transform: 's1,1'  } );
  ...
  var resetNode3 = function() {
    ...
    node31Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node32Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node33Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  ...
  var initNode3 = function() {
    ...
    node3Polygone4Mobile.attr( { visibility: 'visible', transform: 's1,1'  } );
  ...
  var resetNode4 = function() {
    ...
    node41Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node44Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  ...
  var resetNode5 = function() {
    ...
    node51Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node52Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
    ...
    node53Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0.0,0.0' } );
  ...
  var initNode5 = function() {
    ...
    node5Polygone4Mobile.attr( { visibility: 'visible', transform: 's1,1'  } );
  ...
  var node1To12 = function(navigationType) {
    ...
    if(currentState !== 'node-1-2' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node12Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node12Polygone1Mobile.attr( { visibility: 'visible' } );
        node12Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node1To13 = function(navigationType) {
    ...
    if(currentState !== 'node-1-3' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node13Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node13Polygone3Mobile.attr( { visibility: 'visible' } );
        node13Polygone3Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var nodeRootTo2 = function(navigationType) {
    ...
    if(currentState !== 'node-2' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node2Polygone3Mobile.attr( { visibility: 'visible' } );
        node2Polygone3Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      ...
      setTimeout(function() {
        ...
        node2Polygone4.attr( { visibility: 'visible' } );
        node2Polygone4.animate({ transform: 's1,1' }, 200, mina.linear);
        ...
        node2Circle3.attr( { visibility: 'visible' } );
        node2Circle3.animate({ transform: 's1,1' }, 300, mina.linear);
        node2Text1.attr( { visibility: 'visible' } );
        node2Text2.attr( { visibility: 'visible' } );
        node2Text3.attr( { visibility: 'visible' } );
        node2Text4.attr( { visibility: 'visible' } );
      }, 200);
    }
  };
  ...
  var node2To21 = function(navigationType) {
    ...
    if(currentState !== 'node-2-1' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node2.animate({ transform: 's0.60,0.60,t644,-330,r7' }, 200, mina.linear);
        nodeRoot.animate({ transform: 's0.36,0.36,t2015,-885,r8' }, 200, mina.linear);
        ...
        node21Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node21Polygone3Mobile.attr( { visibility: 'visible' } );
        node21Polygone3Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node2To22 = function(navigationType) {
    ...
    if(currentState !== 'node-2-2' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        nodeRoot.animate({ transform: 's0.36,0.36,t-460,-1039,r-6' }, 200, mina.linear);
        ...
        node22Polygone7Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node22Polygone7Mobile.attr( { visibility: 'visible' } );
        node22Polygone7Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node2To23 = function(navigationType) {
    var breakNavigation = false;
    if(level == 3 && navigationType == NavigationType.GRAPHIC) {
      breakNavigation = true;
    }

    if(currentState !== 'node-2-3' && !breakNavigation) {
      currentState = 'node-2-3';
      navigate(dataTree.root.node2.node3, true);
      changeLevel(3);

      $('.nav-node-2-child.level-2').show();
      $('.nav-node-2-3').first().addClass('active');

      setTimeout(function() {
        node2.attr( { cursor: 'pointer' } );
        node2.animate({ transform: 's0.60,0.60,t483,575,r-5' }, 200, mina.linear);
        nodeRoot.animate({ transform: 's0.36,0.36,t1647,500,r-6' }, 200, mina.linear);
        node23.attr( { visibility: 'visible' } );

        initNode2();
        resetNode2();

        node2Polygone4.attr( { visibility: 'hidden' } );
        node2Circle3.attr( { visibility: 'hidden' } );
        node2Text4.attr( { visibility: 'hidden' } );

        node23Polygone1.attr( { visibility: 'hidden', transform: 's0,0' } );
        node23Polygone1.attr( { visibility: 'visible' } );
        node23Polygone1.animate({ transform: 's1,1' }, 100, mina.linear);
        node23Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node23Polygone1Mobile.attr( { visibility: 'visible' } );
        node23Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);

      setTimeout(function() {
        node23Polygone2.attr( { visibility: 'visible' } );
        node23Polygone2.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Polygone3.attr( { visibility: 'visible' } );
        node23Polygone3.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Polygone4.attr( { visibility: 'visible' } );
        node23Polygone4.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Circle1.attr( { visibility: 'visible' } );
        node23Circle1.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Circle2.attr( { visibility: 'visible' } );
        node23Circle2.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Circle3.attr( { visibility: 'visible' } );
        node23Circle3.animate({ transform: 's1,1' }, 300, mina.linear);
        node23Text1.attr( { visibility: 'visible' } );
        node23Text2.attr( { visibility: 'visible' } );
        node23Text3.attr( { visibility: 'visible' } );
        node23Text4.attr( { visibility: 'visible' } );
      }, 200);
    }
  };
  ...
  var nodeRootTo3 = function(navigationType) {
    ...
    if(currentState !== 'node-3' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node3Polygone4Mobile.attr( { visibility: 'visible' } );
        node3Polygone4Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
  ...
  var node3To31 = function(navigationType) {
    ...
    if(currentState !== 'node-3-1' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node31Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node31Polygone1Mobile.attr( { visibility: 'visible' } );
        node31Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node3To32 = function(navigationType) {
    ...
    if(currentState !== 'node-3-2' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node32Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node32Polygone1Mobile.attr( { visibility: 'visible' } );
        node32Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node3To33 = function(navigationType) {
    ...
    if(currentState !== 'node-3-3' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node33Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node33Polygone1Mobile.attr( { visibility: 'visible' } );
        node33Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var nodeRootTo4 = function(navigationType) {
    ...
    if(currentState !== 'node-4' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node4Polygone5Mobile.attr( { visibility: 'visible' } );
        node4Polygone5Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
  ...
  var node4To41 = function(navigationType) {
    ...
    if(currentState !== 'node-4-1' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node41Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node41Polygone3Mobile.attr( { visibility: 'visible' } );
        node41Polygone3Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node4To44 = function(navigationType) {
    ...
    if(currentState !== 'node-4-4' && !breakNavigation) {
      ...
      navigate(dataTree.root.node4.node4, true);
      changeLevel(3);
      ...
      setTimeout(function() {
        ...
        node44Polygone3Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node44Polygone3Mobile.attr( { visibility: 'visible' } );
        node44Polygone3Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var nodeRootTo5 = function(navigationType) {
    ...
    if(currentState !== 'node-5' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node5Polygone4Mobile.attr( { visibility: 'visible' } );
        node5Polygone4Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
  ...
  var node5To51 = function(navigationType) {
    ...
    if(currentState !== 'node-5-1' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node51Polygone1Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node51Polygone1Mobile.attr( { visibility: 'visible' } );
        node51Polygone1Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node5To52 = function(navigationType) {
    ...
    if(currentState !== 'node-5-2' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node52Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node52Polygone4Mobile.attr( { visibility: 'visible' } );
        node52Polygone4Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var node5To53 = function(navigationType) {
    ...
    if(currentState !== 'node-5-3' && !breakNavigation) {
      ...
      setTimeout(function() {
        ...
        node53Polygone4Mobile.attr( { visibility: 'hidden', transform: 's0,0' } );
        node53Polygone4Mobile.attr( { visibility: 'visible' } );
        node53Polygone4Mobile.animate({ transform: 's1,1' }, 100, mina.linear);
      }, 50);
  ...
  var changeLevel = function(newLevel) {
    ...
    if(newLevel == 1) {
      if(nodeRoot) {
        ...
        node2.removeClass('hidden-sm hidden-xs');
        node3.removeClass('hidden-sm hidden-xs');
        node4.removeClass('hidden-sm hidden-xs');
        node5.removeClass('hidden-sm hidden-xs');
      ...
      node2.addClass('hidden-sm hidden-xs');
      node3.addClass('hidden-sm hidden-xs');
      node4.addClass('hidden-sm hidden-xs');
      node5.addClass('hidden-sm hidden-xs');
  ...
  var navigate = function(node, changeNavigationInfo) {
    ...
    if(node.content) {
      ...
      $('.content-window-content-link span:eq( 1 )').hide();
      $('.content-window-content-link-mobile span:eq( 1 )').hide();
      $('.content-window-content-link a:eq( 1 )').hide();
      $('.content-window-content-link-mobile a:eq( 1 )').hide();
      if(node.link) {
        ...
        var match = node.link.match(/\d+/);
        var linkTheme = parseInt(match[0], 10);
        if(linkTheme) {
          var color = getCurrentColor(linkTheme.toString());
          $('.content-window-content-link span:eq( 0 )').css('color', color);
          $('.content-window-content-link-mobile span:eq( 0 )').css('color', color);
        } else {
          $('.content-window-content-link span:eq( 0 )').css('color', '');
          $('.content-window-content-link-mobile span:eq( 0 )').css('color', '');
        }
        $('.content-window-content-link a:eq( 0 )').html(objectByString(dataTree, node.link + '.title'));
        $('.content-window-content-link a:eq( 0 )').attr('id', 'node-link-' + node.link.split('.').join(''));
        $('.content-window-content-link-mobile a:eq( 0 )').html(objectByString(dataTree, node.link + '.title'));
        $('.content-window-content-link-mobile a:eq( 0 )').attr('id', 'node-link-' + node.link.split('.').join('') + '-mobile');
        if(node.link2) {
          $('.content-window-content-link span:eq( 1 )').show();
          $('.content-window-content-link-mobile span:eq( 1 )').show();
          $('.content-window-content-link a:eq( 1 )').show();
          $('.content-window-content-link-mobile a:eq( 1 )').show();
          var match = node.link2.match(/\d+/);
          var linkTheme = parseInt(match[0], 10);
          if(linkTheme) {
            var color = getCurrentColor(linkTheme.toString());
            $('.content-window-content-link span:eq( 1 )').css('color', color);
            $('.content-window-content-link-mobile span:eq( 1 )').css('color', color);
          } else {
            $('.content-window-content-link span:eq( 1 )').css('color', '');
            $('.content-window-content-link-mobile span:eq( 1 )').css('color', '');
          }
          $('.content-window-content-link a:eq( 1 )').html(objectByString(dataTree, node.link2 + '.title'));
          $('.content-window-content-link a:eq( 1 )').attr('id', 'node-link-' + node.link2.split('.').join(''));
          $('.content-window-content-link-mobile a:eq( 1 )').html(objectByString(dataTree, node.link2 + '.title'));
          $('.content-window-content-link-mobile a:eq( 1 )').attr('id', 'node-link-' + node.link2.split('.').join('') + '-mobile');
        }
        rebindNodeLinks();
      } else {
  ...
  var node12Polygone1Mobile = Snap.select('#node-1-2-polygone-1-mobile');
  ...
  var node13Polygone3Mobile = Snap.select('#node-1-3-polygone-3-mobile');
  ...
  var node21Polygone3Mobile = Snap.select('#node-2-1-polygone-3-mobile');
  ...
  var node22Polygone7Mobile = Snap.select('#node-2-2-polygone-7-mobile');
  ...
  var node23 = Snap.select('#node-2-3');
  var node23Polygone1 = Snap.select('#node-2-3-polygone-1');
  var node23Polygone1Mobile = Snap.select('#node-2-3-polygone-1-mobile');
  var node23Polygone2 = Snap.select('#node-2-3-polygone-2');
  var node23Polygone3 = Snap.select('#node-2-3-polygone-3');
  var node23Polygone4 = Snap.select('#node-2-3-polygone-4');
  var node23Circle1 = Snap.select('#node-2-3-circle-1');
  var node23Circle2 = Snap.select('#node-2-3-circle-2');
  var node23Circle3 = Snap.select('#node-2-3-circle-3');
  var node23Text1 = Snap.select('#node-2-3-text-1');
  var node23Text2 = Snap.select('#node-2-3-text-2');
  var node23Text3 = Snap.select('#node-2-3-text-3');
  var node23Text4 = Snap.select('#node-2-3-text-4');
  ...
  var node3Polygone4Mobile = Snap.select('#node-3-polygone-4-mobile');
  ...
  var node31Polygone1Mobile = Snap.select('#node-3-1-polygone-1-mobile');
  ...
  var node32Polygone1Mobile = Snap.select('#node-3-2-polygone-1-mobile');
  ...
  var node33Polygone1Mobile = Snap.select('#node-3-3-polygone-1-mobile');
  ...
  var node4Polygone5Mobile = Snap.select('#node-4-polygone-5-mobile');
  ...
  var node41Polygone3Mobile = Snap.select('#node-4-1-polygone-3-mobile');
  ...
  var node44Polygone3Mobile = Snap.select('#node-4-4-polygone-3-mobile');
  ...
  var node5Polygone4Mobile = Snap.select('#node-5-polygone-4-mobile');
  ...
  var node51Polygone1Mobile = Snap.select('#node-5-1-polygone-1-mobile');
  ...
  var node52Polygone4Mobile = Snap.select('#node-5-2-polygone-4-mobile');
  ...
  var node53Polygone4Mobile = Snap.select('#node-5-3-polygone-4-mobile');
  ...
  node2Polygone4.click(function(event) {
    node2To23(NavigationType.GRAPHIC);
    event.stopPropagation();
  });
  node2Circle3.click(function(event) {
    node2To23(NavigationType.GRAPHIC);
    event.stopPropagation();
  });
  node2Text4.click(function(event) {
    node2To23(NavigationType.GRAPHIC);
    event.stopPropagation();
  });
  ...
  node21Polygone6.click(function(event) {
    node21To211();
  });
  node21Circle6.click(function(event) {
    node21To211();
  });
  node21Text6.click(function(event) {
    node21To211();
  });
  node21Polygone5.click(function(event) {
    node21To212();
  });
  node21Circle7.click(function(event) {
    node21To212();
  });
  node21Text7.click(function(event) {
    node21To212();
  });
  node21Polygone4.click(function(event) {
    node21To213();
  });
  node21Circle1.click(function(event) {
    node21To213();
  });
  node21Text1.click(function(event) {
    node21To213();
  });
  node21Polygone1.click(function(event) {
    node21To214();
  });
  node21Circle4.click(function(event) {
    node21To214();
  });
  node21Text4.click(function(event) {
    node21To214();
  });
  node22Polygone4.click(function(event) {
    node22To221();
  });
  node22Circle5.click(function(event) {
    node22To221();
  });
  node22Text5.click(function(event) {
    node22To221();
  });
  node22Polygone2.click(function(event) {
    node22To222();
  });
  node22Circle6.click(function(event) {
    node22To222();
  });
  node22Text6.click(function(event) {
    node22To222();
  });
  node22Polygone5.click(function(event) {
    node22To223();
  });
  node22Circle1.click(function(event) {
    node22To223();
  });
  node22Text1.click(function(event) {
    node22To223();
  });
  node22Polygone1.click(function(event) {
    node22To224();
  });
  node22Circle2.click(function(event) {
    node22To224();
  });
  node22Text2.click(function(event) {
    node22To224();
  });
  node22Polygone6.click(function(event) {
    node22To225();
  });
  node22Circle3.click(function(event) {
    node22To225();
  });
  node22Text3.click(function(event) {
    node22To225();
  });
  node22Polygone3.click(function(event) {
    node22To226();
  });
  node22Circle4.click(function(event) {
    node22To226();
  });
  node22Text4.click(function(event) {
    node22To226();
  });
  node23Polygone2.click(function(event) {
    node23To231();
  });
  node23Circle1.click(function(event) {
    node23To231();
  });
  node23Text2.click(function(event) {
    node23To231();
  });
  node23Polygone3.click(function(event) {
    node23To232();
  });
  node23Circle2.click(function(event) {
    node23To232();
  });
  node23Text3.click(function(event) {
    node23To232();
  });
  node23Polygone4.click(function(event) {
    node23To233();
  });
  node23Circle3.click(function(event) {
    node23To233();
  });
  node23Text4.click(function(event) {
    node23To233();
  });
