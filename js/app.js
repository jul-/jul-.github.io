var App = Backbone.View.extend({
    ...
    resetMap: function(){
        ...
        TweenMax.to( $(this.el), .4, {css: {scale: this.screen_ratio}});
        TweenMax.to( $(this.el), .4, {css: {backfaceVisibility: 'hidden'}});
        TweenMax.to( $(this.el), .4, {css: {z: 0, x: -this.origin_x, y: -this.origin_y}});
    },
