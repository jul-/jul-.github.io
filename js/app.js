var App = Backbone.View.extend({
    ...
    activateMap: function($event){
        ...
        TweenMax.to( $(this.el), 1.4,{css:{scale:1, backfaceVisibility: 'hidden', z: 0, x: this.origin_x, y: this.origin_y}});

    },
    resetMap: function(){
        console.log('resetmap 7');
        this.map_active = false;
        $(this.el).removeClass('active');
        TweenMax.to( $(this.el), 1.4, {css: {scale: this.screen_ratio, backfaceVisibility: 'hidden', z: 0, x: 0, y: 0}});
    },
    focusOn: function(data){
        ...
        if(!this.map_active)
            ...
            TweenMax.to( $(this.el), 1.5, {css: {x: -this.origin_x, y: -this.origin_y}});
